...
import static org.hockey.hockeyware.client.util.player.PlayerUtil.getBlockHeight;
...
public class Step extends Module {
    ...
    public static final Setting<Stepmode> mode = new Setting<>("Mode", Stepmode.Normal);
    public static final Setting<Float> height = new Setting<>("Height", 1f, 1f, 6f);
