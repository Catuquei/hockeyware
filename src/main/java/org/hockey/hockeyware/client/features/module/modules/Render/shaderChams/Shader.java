package org.hockey.hockeyware.client.features.module.modules.Render.shaderChams;
...
public abstract class Shader {
    ...
    public Shader(final String fragmentShader) {
        ...
        try {
            final InputStream vertexStream = this.getClass().getResourceAsStream("/assets/hockeyware/shaders/shaderChams/vertex.vert");
            vertexShaderID = this.createShader(IOUtils.toString(vertexStream, Charset.defaultCharset()), 35633);
            IOUtils.closeQuietly(vertexStream);
            final InputStream fragmentStream = this.getClass().getResourceAsStream("/assets/hockeyware/shaders/shaderChams/fragment/" + fragmentShader);
