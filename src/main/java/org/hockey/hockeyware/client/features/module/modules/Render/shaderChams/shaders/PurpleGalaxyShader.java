...
public class PurpleGalaxyShader extends FramebufferShader {
    public static PurpleGalaxyShader PurpleGalaxy_Shader;
    public float time;
    public float timeMult = 0.005f;

    public PurpleGalaxyShader() {
        super("purpleGalaxy.frag");
    }
    ...
    static {
        PurpleGalaxy_Shader = new PurpleGalaxyShader();
    }
}