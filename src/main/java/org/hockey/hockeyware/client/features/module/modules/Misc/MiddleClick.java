...
public class MiddleClick extends Module {
    ...
    public static final Setting<Boolean> pearl = new Setting<>("Pearl", false);
    public static final Setting<Boolean> exp = new Setting<>("Exp", false);
    ...
    public MiddleClick() {
        super("MiddleClick", "Allows You To Do Different Functions With Middle Click", Category.Misc);
    }
            ...
            if (!this.clicked) {
                ...
                if (friend.getValue() && (result = MiddleClick.mc.objectMouseOver) != null && result.typeOfHit == RayTraceResult.Type.ENTITY) {
                    ...
                    if (!(entity instanceof EntityPlayer)) return;
                        ...
                        if (HockeyWare.INSTANCE.friendManager.isFriend(entity.getUniqueID())) {
                            Friend friend = HockeyWare.INSTANCE.friendManager.getFriend(entity.getUniqueID());
                            ...
                            HockeyWare.INSTANCE.friendManager.add(new Friend(entity.getUniqueID(), entity.getName()));
    ...
    public float getNearestPlayer() {
        for (EntityPlayer player : mc.world.playerEntities) {
            if (!(getHockey().friendManager.isFriendByName(player.getName()))) {
