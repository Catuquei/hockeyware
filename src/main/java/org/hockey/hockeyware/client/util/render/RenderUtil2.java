...
//        mc.getRenderManager().setRenderOutlines(false);
    ...
    public static int fontManager() {
        return mc.fontRenderer.FONT_HEIGHT;
    }

    public static void drawText(BlockPos pos, String text) {
        GlStateManager.pushMatrix();
        RenderUtil2.glBillboardDistanceScaled((float) pos.getX() + 0.5f, (float) pos.getY() + 0.5f, (float) pos.getZ() + 0.5f, RenderUtil.mc.player, 1.0f);
        GlStateManager.disableDepth();
